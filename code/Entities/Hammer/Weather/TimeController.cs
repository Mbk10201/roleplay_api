...
public partial class TimeController : ModelEntity
{
	...
	private void HandleTimeSectionChanged( eTimeSection section )
	{
		if ( section == eTimeSection.Dawn )
			OnBecomeDawn.Fire( this );
		else if ( section == eTimeSection.Day )
			OnBecomeDay.Fire( this );
		else if ( section == eTimeSection.Dusk )
			OnBecomeDusk.Fire( this );
		else if ( section == eTimeSection.Night )
